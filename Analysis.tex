...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# v ggplot2 3.2.1\ \ \ \  v readr\ \  1.3.1\\\#\# v tibble\ \ 2.1.3\ \ \ \  v purrr\ \  0.3.3\\\#\# v tidyr\ \  1.0.0\ \ \ \  v stringr 1.4.0\\\#\# v ggplot2 3.2.1\ \ \ \  v forcats 0.4.0}}
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-2} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-3} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-4} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-5} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-6} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-7} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-8} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-9} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-10} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-11} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-12} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-13} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-14} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-15} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-16} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-17} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-18} 
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-19} 
...
\hlstd{model_red} \hlkwb{<-} \hlkwd{lm}\hlstd{(}
    \hlstd{`Life Expectancy`} \hlopt{~} \hlstd{`Birth Rate`} \hlopt{+} \hlstd{`Stroke Rate`} \hlopt{+}  \hlstd{`Health Expenditure`} \hlopt{+} \hlstd{EPI} \hlopt{+} \hlstd{GDP,}
    \hlkwc{data} \hlstd{= model_full}\hlopt{$}\hlstd{model)}
\hlcom{# Has violations of assumptions (see below)}
\hlcom{# Note: data = model_full$model in reduced }
\hlcom{#    model to avoid "models were not all fitted to the same size of dataset" error in ANOVA}


\hlcom{# Model BC Full --- Box-Cox Full Transform}
\hlkwd{boxcox}\hlstd{(model_full,} \hlkwc{plotit} \hlstd{=} \hlnum{TRUE}\hlstd{,} \hlkwc{lambda} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{3}\hlstd{,} \hlnum{5}\hlstd{,} \hlkwc{by} \hlstd{=} \hlnum{0.1}\hlstd{))}
\end{alltt}
\end{kframe}
...
\begin{kframe}\begin{alltt}
\hlstd{transform_bc_y} \hlkwb{<-} \hlstd{((life_exp_full}\hlopt{$}\hlstd{`Life Expectancy`)}\hlopt{^}\hlnum{4.4} \hlopt{-} \hlnum{1}\hlstd{)}\hlopt{/}\hlnum{4.5}
...
{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-28} 
...
\hlcom{# Breusch-Pagan}
\hlkwd{bptest}\hlstd{(model_bc_full_transform)}
\end{alltt}
\begin{verbatim}
## 
## 	studentized Breusch-Pagan test
...
\hlcom{# Shapiro-Wilks}
\hlkwd{shapiro.test}\hlstd{(}\hlkwd{resid}\hlstd{(model_bc_full_transform))}
\end{alltt}
\begin{verbatim}
## 
## 	Shapiro-Wilk normality test
...
\hlcom{# Box-cox}
\hlkwd{boxcox}\hlstd{(model_bc_full_transform)}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.6\linewidth]{figure/Analysis-Rnwauto-report-29} 
